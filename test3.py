        ...
        for page in doc.pages:
            for line in page.lines:
                EXTRACTED_BLOCKS.append({
                    ...
                    "text": line.text,
                    "bb": {
                        "x1": line.geometry.bounding_box.left,
                        "y1": line.geometry.bounding_box.top,
                        "x2": line.geometry.bounding_box.left + line.geometry.bounding_box.width,
                        "y2": line.geometry.bounding_box.top + line.geometry.bounding_box.height,
                    }
                })
